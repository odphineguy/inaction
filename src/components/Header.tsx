...
const Header = () => {
  ...
  return (
    <header className="bg-black/95 backdrop-blur-sm border-b border-border sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <img src="/inaction/NoBkInActionLogo.png" alt="InAction Fitness Logo" className="h-[96px] w-auto" />
            <div>
